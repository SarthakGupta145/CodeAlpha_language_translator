...
class LanguageTranslator:
    ...
    def Widgets(self):
        ...
        self.logo = ttk.PhotoImage(logo).subsample(5, 5)
        ...
        image = Image.open("icon.jpeg")
        arrows = ImageTk.PhotoImage(image)
        self.arrow_icon = ttk.PhotoImage(arrows)
        ...
        copy = ImageTk.PhotoImage(image)
        self.speaker_icon = ttk.PhotoImage(speaker).subsample(5, 4)
        self.copy_icon = ttk.PhotoImage(copy).subsample(5, 4)
